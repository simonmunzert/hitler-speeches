...
c("../figures/tab-summary-stats-1928.tex",
  ...
  "../figures/tab-treatmentvars.tex",
  "../figures/tab-treatmentvars2.tex",
  "../figures/map_communities_points.pdf",
  "../figures/map_counties_points.pdf",
  "../figures/map_nsdap_votesharediff_309.pdf",
  "../figures/map_nsdap_votesharediff_327.pdf",
  "../figures/map_nsdap_votesharediff_32n.pdf",
  "../figures/map_nsdap_votesharediff_333.pdf",
  "../figures/elect_returns_timeline.pdf")
